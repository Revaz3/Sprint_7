...
class TestCreateCourier:
    ...
    @allure.title('Тест успешного создания курьера при заполненных обязательных полях')
    @allure.description('Проверка получения кода 201 Created и сообщения {"ok": True} при отправке POST-запроса на создание курьера при заполненных полях login и password валидными данными')
    ...
    @allure.description('Проверка получения кода 201 Created и сообщения {"ok": True} при отправке POST-запроса на создание курьера при заполненных полях login, password и firstName валидными данными')
    ...
    @allure.description('Проверка получения кода 400 Bad request и сообщения {"message": "Недостаточно данных для создания учетной записи"} при отправке POST-запроса на создание курьера при незаполненных полях login/password')
    ...
    @allure.description('Проверка получения кода 409 Conflict и сообщения {"message": "Этот логин уже используется"} при отправке POST-запроса на создание курьера при использовании существующего логина')
